                ...
                <div class="col-md-6 m-auto">
                    ...
                    <a href="" class="btn btn-primary text-light px-1 py-0"> <i class="fa fa-instagram"></i> </a>
                        ...
                        <div class="col-md-6 p-2 text-right">
                             ...
                             <a href="" class="text-light "> <i class="fa fa-envelope"></i>infoparadox2@gmail.com</a>
                    </div>
             </div>
    </div>
      ...
      <div class="col-lg-12">
       ...
       <div class="row">
           <div class="col-md-6 m-auto section text-center">
               ...
               <h4></h4>
               <p class="small text-justify text-center" style=""> We’re a super dynamic team of go-getters, who believe in themselves, and the idea that drives them.</p>
               <p class="small text-justify text-center"><b> paradox</b> is built around the idea that everyone should have access to fresh groceries, no matter where they stay, what do they do, and how tech savvy are they. If you think you can offer the same level of convenience to our customers through what you do, please drop in or just drop down a mail to <b>infoparadox2@gmail.com.</b></p>
           </div>
       </div><br><br>
