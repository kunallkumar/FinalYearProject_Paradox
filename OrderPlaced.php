           ...
           <div class="card shadow-sm mt-4">
              <div class="row">
                ...
                <div class="col-lg-3 " style="border-left:solid #ccc 1px">
                 <span style="font-size:130%;font-family: 'Josefin Sans', sans-serif;margin-left:5%;margin-top:20%">Why call? just click!</span> <br> <span style="font-size:80%;margin-left:5%">Easily Track your foodstuff order</span><br><br>
          ...
          <div class="card shadow-sm mt-4 text-capitalize" style="font-family: 'Josefin Sans', sans-serif;">
              <div class="row mt-4 ml-3">
                ...
                <div class="col-lg-4" style="border-left: solid 1px #ccc">
                  ...
                  <h6>Get Free Subscription For your Healty and fresh Diet. </h6> <br>
                  <h6>Get Free Home delivery on shopping of Rs.99 or above.</h6>
                </div>

                <div class="col-lg-4" style="border-left: solid 1px #ccc">
                  <h6 style="font-size:150%;color:black"><i class="fas fa-network-wired"></i>  More Actions</h6><hr>
                  <p><a href="register_vendor_account.php" style="color:#556"><i class="fas fa-handshake text-info"></i>  sell your products with us, if you have.</a></p>
                  <p> <a href="Contact.php" style="color:#556"><i class="fas fa-comment-dots text-info"></i>  Feedback for our service</a> </p>
                  <p style="color:#556"><i class="fab fa-get-pocket text-info" ></i>   Get in touch with us: <br> <a href="#" style="color:#556; margin-left:5%">infoparadox@gmail.com</a> </p>
          ...
          <div class="card shadow-sm mt-4 text-capitalize" style="font-family: 'Josefin Sans', sans-serif;">
            <div class="row">
                  ...
                  <div class="col-lg-3 mt-5">
                   ...
                   <b> Total ₹<?= $p_row['p_price']*$o_row['qty']?>/-</b>
                  </div>
