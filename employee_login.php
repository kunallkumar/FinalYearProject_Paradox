	...
	<div class="login-container d-flex align-items-center justify-content-cent" style="margin-top:60px">
		<form class="login-form text-center" action="employee_login.php" method="post">
			...
			<div class="form-group">
				<input type="text" class="form-control rounded-pill form-control-lg" placeholder="Enter your registered email id" name='emp_email'>
			</div>
			<div class="form-group">
				<input type="password" class="form-control rounded-pill form-control-lg" placeholder="Enter your password" name="emp_pass">
			</div>
			<a href="forget_emp_pass.php">Forgot password?</a>
