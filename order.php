               ...
               <div class="card-body ">
                 <div class="row">
                       ...
                       <div class="col-lg-5">
                         ...
                         <span style="color:blue"><?= $p_row['p_discount']?></span>
                        </div>
             ...
             <div class="card shadow-sm mt-3" style="width:100%">
               ...
               <div class="card-body ">
                 <div class="row">
                        ...
                        <a href="#"  data-toggle="modal" data-target="#payModal" style="color:red"> <u>Go Cashless</u> </a>
             ...
             <?php
                 ...
                 $id=date('Ymdhis');
                   if(isset($_POST['order'])){
                     ...
                     send_sms($_POST['c_phn'],"Dear " . $_POST['c_f_name'] . ",Your Order for ".$_POST['p_name']." has been Placed successfully!");
                     ...
                     $mail = new PHPMailer(true);
                       ...
                       try{
                        $mail->isSMTP();
                         ...
                         $mail->SMTPAuth = true;
                         $mail->Username = 'infoparadox2@gmail.com'; // Gmail address which you want to use as SMTP server
                         $mail->Password = 'info@paradox12'; // Gmail address Password
                         $mail->SMTPSecure = "tls";
                         $mail->Port = 587;
                         $mail->CharSet = "UTF-8";

                         $mail->setFrom('infoparadox2@gmail.com'); // Gmail address which you used as SMTP server
                         $mail->addAddress($email); // Email address where you want to receive emails (you can use any of your gmail address including the gmail address which you used as SMTP server)

                         $mail->isHTML(true);
                         $mail->Subject = 'Your Order has been placed ';
                         $mail->Body = "<h3>Dear $name , <br>your order for $prd_name has been placed successfully!<br>Your Order Id is $id <br>Thank you for shopping!</h3>";
                           ...
                           <div class="card shadow">
                             ...
                             <div class="card-body">
                               <table style="width:100%">
                                 ...
                                 <tr>
                                   <th>Total</th>
                                   <td style="float:right">₹ <span class="total"><?= $r['p_price']?></span>/-</td>
                                 </tr>
                               </table>
                             </div>
...
<img src="https://img.icons8.com/color/48/000000/paytm.png"/> 7033279724
</div>
