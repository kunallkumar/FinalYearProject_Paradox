            ...
            <div class="row">
                <div class="col-lg-6 m-auto">
                    <form class="login-form text-center" method="post" action="register_customer_account.php" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        <input type="password" id="txtNewPassword" placeholder="Enter password" name="c_pass"class="form-control rounded-pill form-control-lg" required>
                                    </div>

                                    <div class="form-group col-5">
                                        <input  type="password" id="txtConfirmPassword" placeholder="Confirm password" name="c_con_pass" class="form-control rounded-pill form-control-lg" required>
                                    </div>
