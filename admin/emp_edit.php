      ...
      <div class="col-lg-10 m-auto">
        ...
        <?php
          if(isset($_POST['update'])){
            ...
            set
           emp_f_name='$emp_f_name',emp_L_name='$emp_L_name',emp_phn='$emp_phn',emp_email='$emp_email',emp_add='".mysql_real_escape_string($emp_add)."',emp_pin='$emp_pin',emp_age='$emp_age',emp_gen='$emp_gen',emp_city='$emp_city',emp_state='$emp_state' where emp_id='$emp_id'";
            mysql_query($update);
