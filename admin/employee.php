        ...
        <div class="col-lg-9">
            <div class="row">
                    ...
                    <div class="col-4">
                      ...
                      <form action="employee.php"  method="get" class="form-inline mt-3">
                          <input type="search" placeholder="Search Employee" class="form-control" name="emp_search" value="<?php if(isset($_GET['emp_search'])){echo $_GET['emp_search'];}?>">
                            <?php
                            if(isset($_GET['emp_search'])): ?>
                              <a href="employee.php" class="btn btn-danger">X</a>
          ...
          <table class="table table-bordered">
            ...
            if(isset($_GET['find'])):
              ...
              $calling=mysql_query("SELECT * from employee where emp_f_name like '%$search%' or emp_L_name like '%$search%' or emp_code= '$search' or emp_email like '%$search%'");
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <table class="table table-bordered mt-5">
                                  ...
                                  <tr>
                                    <th> Employee Adhaar No..</th>
                                    <td><?= $row['emp_adhaar']?></td>
