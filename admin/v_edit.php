      ...
      <div class="col-lg-10 m-auto">
        ...
        <?php
          if(isset($_POST['update'])){
            ...
            set
            v_f_name='$v_f_name',v_L_name='$v_L_name',v_phn='$v_phn',v_email='$v_email',v_add='".mysql_real_escape_string($v_add)."',v_pin='$v_pin',v_age='$v_age',v_gen='$v_gen',v_city='$v_city',v_state='$v_state' where v_id='$v_id'";
            mysql_query($update);
