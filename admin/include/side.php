...
<a href="category.php" class="list-group-item list-group-item-action">Categories</a>
      <a href="admin_order.php" class="list-group-item list-group-item-action">Orders</a>
    ...
    <a href="vendors.php" class="list-group-item list-group-item-action">Vendors</a>
      <a href="employee.php" class="list-group-item list-group-item-action">Employee</a>
        <a href="message.php" class="list-group-item list-group-item-action">Messages From Customers</a>
