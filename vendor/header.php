<nav class="navbar navbar-expand-lg sticky-top"  style="background:linear-gradient(#f18c8e,#f1d1b5,#f0b7a4)">
  <div class="navbar-header">
      <a href="index.php" class="navbar-brand text-dark"><img src="..\image\logo2.png" alt="" height=35% width=120px></a>
  </div>
    ...
    <?php
        ...
        <li class=nav-item"">  <div class="dropdown nav-link ">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" href="v_profile.php">My Profile</a>
          ...
          <li class="nav-item">
            <a href="Dashboard.php" class="text-dark mr-2">Change_Data</a>&nbsp;
          </li>
          <li class="nav-item">
