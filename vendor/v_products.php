          ...
          <table class="table table-bordered text-center">
            ...
            <tr>
              ...
              if(isset($_GET['find'])):
                ...
                $calling = mysql_query("SELECT * from product where p_name like '%$search%' or p_code= '$search' and v_email='$log'");
              ...
              <td>
                ...
                <a href='v_prod_edit.php?edit=<?= $row['p_id']?>' class="btn btn-info">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <a href="v_prod_del.php?del=<?= $row['p_id']?>" class="btn btn-primary">Yes</a>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <table class="table table-bordered mt-5">
                          <tr>
                            ...
                            <td><?= $row['p_code'];?></td>
                              ...
                              <tr>
                                <th>weight for each unit</th>
                                  <td><?= $row['each_qty'];?></td>
                              </tr>
                              <tr>
                                <th>Price for each unit</th>
                                  <td><?= $row['p_price'];?></td>
                              </tr>
                              <tr>
                                <th>Total stock</th>
