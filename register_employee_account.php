                    ...
                    <form class="login-form text-center" enctype="multipart/form-data" method="post" action="register_employee_account.php" >
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input type="password" id="txtNewPassword" placeholder="Create password" name="emp_pass"class="form-control rounded-pill form-control-lg" required>
                                    </div>

                                    <div class="form-group col-5">

                                        <input  type="password" id="txtConfirmPassword" placeholder="Confirm Password" name="emp_con_pass" class="form-control rounded-pill form-control-lg"  required>
                                    </div>
