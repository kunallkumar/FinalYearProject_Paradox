...
<u> <h2 style="font-family:'cursive'">MY PROFILE</h2></u>
      <?php
        ...
        if(isset($_SESSION['employee'])):
          ...
          $calling = mysql_query("select * from employee where emp_email='$log'");
		  ...
		  <table class="table table-bordered mt-5">
                                ...
                                <tr>
                                  <th> photo</th>
                                          ...
                                          <td><img src="..\image\<?= $row['emp_img'];?>" alt="" height="40px" width="40px"></a></td>

                                </tr>
      </table>
<?php endif;?>
                  <a href='emp_profile_edit.php?edit=<?= $row['emp_id']?>' class="btn btn-info">
