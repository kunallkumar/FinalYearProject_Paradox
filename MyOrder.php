        ...
        <div class="col-lg-12">
          <div class="card mb-4">
                  <div class=" bordered p-2">
                    <div class="card bg-info text-white" style="width:21%;height:40px;padding-left:1.5%;padding-top:0.5%"> ORDER NO.: <?= $order_data['invoice_no'];?></div>
                  </div>
                                 ...
                                 if($data['order_status']=='Active' || $data['order_status']=='Delivered'):
                                   ...
                                   $del_time=date('H:i d-m-Y',strtotime('+7 hour +20 minutes',strtotime($o_time)));
                                      ...
                                      ?>
                                          ...
                                          <del>  <i class="fas fa-shuttle-van text-info"></i>  Delivery expected till within 2 working days. </del><br><br>
