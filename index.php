...
<!--in the below section banner slider code is written-->
    <div class="container-fluid mb-3 " >
      <div class="row ">
        <div class="col-1g-12" style="margin-top:65px">
                  <div id="demo" class="carousel slide" data-ride="carousel" >
                        ...
                        <div class="carousel-inner">
                          ...
                          <a href="product.php?cat=butters"> <img src="image\Dairy.png"   class="banner" width="100%"  ></a>
                          </div>
                          <div class="carousel-item">
                            <a href="product.php?cat=bakery"><img src="image\BakeryandConfectioneries.png"  class="banner" width="100%"  ></a>
                          </div>
                          <div class="carousel-item">
                          <a href="register_customer_account.php">  <img src="image\FruitsandVeggies.png" class="banner" width="100%" ></a>
                          </div>
                          <div class="carousel-item" >
                            <a href="product.php?cat=juice"><img src="image\beverages.png"  class="banner" width="100%" ></a>
                          </div>
                        </div>
...
for($a=0; $a < $no_of_slide; $a++):
 ...
 ?>
    <li data-target="divya<?= $parent;?>" data-slide-to="<?= $a; ?>"></li>

  <?php endfor;?>
  </ol>
  <div class="container-fluid shadow mb-3 " style="background:white;height:10%;background-repeat:no-repeat;background-size:cover;">
    <h2 class="font-weight-bold text-dark"><?= $cat['cat_title'];?></h2> <span style="margin-top:-20px">Recently added</span>
